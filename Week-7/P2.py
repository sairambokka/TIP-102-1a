...
def reverse_orders(orders):
    ...
    element = arr[0]
    leftover = arr[1:]
    return reverse_orders(" ".join(leftover)) + " " + element
    
# Example Usage:

print(reverse_orders("Bagel Sandwich Coffee Chewy Icecream Chicken Ham McD")) # reverse . append( bagels).       reverse .append( Sandwich).  Coffee
# Example Output:
